...
const Hero: React.FC = () => {
  ...
  return (
    <section className="min-h-screen flex flex-col justify-center items-center text-center px-6 pt-24 pb-12">
      <div className="relative w-[18rem] h-[18rem] sm:w-[22rem] sm:h-[22rem] md:w-[26rem] md:h-[26rem] lg:w-[32rem] lg:h-[32rem] mx-auto mb-16">
      ...
      <h1 className="font-serif text-3xl sm:text-4xl md:text-6xl lg:text-8xl font-bold uppercase tracking-widest text-brand-beige animate-fade-in-up delay-200">
        {translations.hero_title[language]}
      </h1>
      <p className="mt-6 text-base sm:text-lg md:text-xl lg:text-2xl text-brand-gold-light tracking-wider animate-fade-in-up delay-400">
